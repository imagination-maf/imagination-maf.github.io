...
<div class="app">
    ...
    <div class="container" :class="{'blur': soldOutDetails}">
        <div id="area" v-bind:class="{ visible: loaded }">
            ...
            <div id="svg-container" :style="svgContainerScale" :class="propertyTypeFilter" @touchstart="svgPressed($event)">
    ...
    <div class="sold-out" v-if="soldOutDetails">
        <div class="sold-out-content">
            ...
            <button class="sold-out-button" @touchstart="backToOverview()">Back to the Masterplan</button>
        </div>
    </div>
</div>
</template>
