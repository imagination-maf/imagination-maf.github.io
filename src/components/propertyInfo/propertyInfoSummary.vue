...
export default Vue.component('property-info-summary', {
    ...
    computed: {
        ...
        floorplanAvailable: function () {
            return FloorplanMapping[this.$route.query.community] && FloorplanMapping[this.$route.query.community][this.$route.query.neighbourhood] &&
            FloorplanMapping[this.$route.query.community][this.$route.query.neighbourhood][this.property.unit_type];
        }
    },
    methods: {
    ...
    <div class="info-summary">
        ...
        <div class="info-row">
            ...
            <div class="info-details">
                ...
                <div class="info-details-item" v-if="property.price">Price: <span v-if="community !== 'almouj'">AED</span><span v-if="community === 'almouj'">OMR</span>{{ property.price.toLocaleString() }}.00</div>
            </div>
        </div>
    </div>
</template>
